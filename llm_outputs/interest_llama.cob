      *> ============================================================
      *> INTEREST_CALCULATION.COB — Llama "Fix" Output
      *> SYNTHETIC EXAMPLE
      *>
      *> LLAMA BEHAVIOR:
      *>   FIXED:   PIC V9(6) → PIC 9V9(6) for WS-RATE-DAILY
      *>   MISSED:  ON SIZE ERROR absent on compound COMPUTE
      *>   MISSED:  FILE STATUS on ACCOUNT-FILE absent
      *>   MISSED:  WHEN OTHER CONTINUE unchanged
      *>   NEW BUG: Added WS-PRECISION-STORE PIC V9(8) — regression
      *> ============================================================
       ...
       01  WS-CALC-FIELDS.
      *>   LLAMA FIX: PIC V9(6) → PIC 9V9(6). Correct.
      ...
      *>   LLAMA NEW BUG: PIC V9(8) — pure decimal precision store.
      *>   Intended for high-precision intermediate value.
      *>   Any value >= 1.0 silently truncates. Compounding error.
           05  WS-PRECISION-STORE  PIC V9(8).
      ...
      *>   LLAMA MISSED: No ON SIZE ERROR. Silent overflow.
